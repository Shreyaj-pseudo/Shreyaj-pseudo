...
|--------|-------------|-------|
| [🛡️ TruckGuard](https://github.com/Shreyaj-pseudo/TruckGuard) | AI-powered study focus companion — slightly judgmental beaver living in your browser, nudges you back when you drift | Chrome Extension, FastAPI, JS Frontend, LLM-powered semantic analysis | Lightweight AI, Real-time page monitoring, Early stateful memory experiments |
